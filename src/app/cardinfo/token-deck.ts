...
export class TokenDeck {
   static deck: Deck = {
      name: 'TokenDeck',
      cards: [
        {nreps: 32, type: "Debt", name: "Debt", color: "rgb(224,92,0)", cost: null, step: 0, stop: 0, rent: 0, vp: null, subtype: null, props: {noStop: true}, text: null, extras: [  ], path: "Debt.png"},
        {nreps: 12, type: "house", name: "House", color: "rgb(4,201,0)", cost: 2, step: 0, stop: 0, rent: 0.5, vp: 1, subtype: null, props: {noStop: true}, text: null, extras: [ {vp: 1} ], path: "House.png"},
        {nreps: 12, type: "house", name: "Triplex", color: "rgb(4,201,0)", cost: 5, step: 0, stop: 0, rent: 1, vp: 3, subtype: null, props: {noStop: true}, text: null, extras: [ {vp: 3} ], path: "Triplex.png"},
