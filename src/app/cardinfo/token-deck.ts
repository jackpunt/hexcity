...
export class TokenDeck {
   static deck: Deck = {
      name: 'TokenDeck',
      cards: [
        {nreps: 32, type: "Debt", name: "Debt", cost: null, step: 0, stop: 0, rent: 0, vp: null, subtype: null, props: {noStop: true}, path: "Debt.png"},
        {nreps: 12, type: "house", name: "House", cost: 2, step: 0, stop: 0, rent: 0.5, vp: 1, subtype: null, props: {noStop: true}, path: "House.png"},
        {nreps: 12, type: "house", name: "Triplex", cost: 5, step: 0, stop: 0, rent: 1, vp: 3, subtype: null, props: {noStop: true}, path: "Triplex.png"},
